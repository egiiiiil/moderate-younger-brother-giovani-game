...
import components, { CullBounds } from "phaser/src/tilemaps/components";
...
class Giovanni extends Phaser.Scene {
	...
	create() {
		...
		///////////////////////////////GRASS//////////////////////////////////////
		grass = this.add.image(260, 585, "grass");
		grass.setScale(0.4).setDepth(5);
		grass1 = this.add.image(560, 585, "grass");
		grass1.setScale(0.4).setDepth(5);
		grass2 = this.add.image(1200, 585, "grass");
		grass2.setScale(0.4).setDepth(5);
		grass3 = this.add.image(1600, 585, "grass");
		grass3.setScale(0.4).setDepth(5);
		grass4 = this.add.image(1790, 585, "grass");
		grass4.setScale(0.4).setDepth(5);
		grass5 = this.add.image(2050, 585, "grass");
		grass5.setScale(0.4).setDepth(5);

		grass6 = this.add.image(460, 250, "grass");
		grass6.setScale(0.4).setDepth(5);
		grass7 = this.add.image(660, 250, "grass");
		grass7.setScale(0.4).setDepth(5);
		grass8 = this.add.image(1150, 250, "grass");
		grass8.setScale(0.4).setDepth(5);
		grass9 = this.add.image(1300, 250, "grass");
		grass9.setScale(0.4).setDepth(5);
		grass10 = this.add.image(1570, 250, "grass");
		grass10.setScale(0.4).setDepth(5);
		grass11 = this.add.image(2100, 250, "grass");
		grass11.setScale(0.4).setDepth(5);
		...
		this.add.image(-5, 796, "ground4").setDepth(6);
		...
		this.add.image(580, 792, "ground5").setDepth(6);
		...
		this.add.image(1450, 792, "ground5").setDepth(6);
		...
		this.add.image(2100, 792, "ground6").setDepth(6);
		...
		this.add.image(2500, 792, "ground7").setDepth(6);
		...
		this.add.image(-5, 270, "ground1").setDepth(6);
		...
		this.add.image(580, 270, "ground3").setDepth(6);
		...
		this.add.image(1450, 270, "ground3").setDepth(6);
		...
		this.add.image(2100, 270, "ground2").setDepth(6);
		...
		this.add.text(315, 450, "RECEPTION", {
			fontFamily: "dogicabold, monospace",
			fontSize: 20,
			color: "black",
		});
		this.add.text(315, 420, "Hyper Island", {
			fontFamily: "dogicabold, monospace",
			fontSize: 15,
			color: "black",
		});
		...
		this.add.text(650, 550, "ROOTS", {
			fontFamily: "dogicabold, monospace",
			fontSize: 20,
			color: "white",
		});
		this.add.text(680, 575, "Cafe", {
		...
		this.add.image(1120, 570, "sofa1").setDepth(6);
		this.add.image(1290, 570, "sofa2").setDepth(6);
		this.add.image(1350, 570, "sofa1").setDepth(6);
		...
		this.add.image(2200, 575, "stairs");
		...
		this.add.image(2150, 575, "stairs");
		...
		this.add.image(2100, 575, "stairs").setDepth(6);
		...
		this.add.image(2050, 575, "stairs").setDepth(6);
		...
		this.add.image(2200, 525, "stairs");
		...
		this.add.image(2150, 525, "stairs");
		...
		this.add.image(2100, 525, "stairs");
		...
		this.add.image(2200, 475, "stairs");
		...
		this.add.image(2150, 475, "stairs");
		...
		this.add.image(2200, 425, "stairs");
		...
		this.add.image(2415, 585, "blocks");
		////////2/////
		...
		this.add.image(2625, 575, "blocks");
		///////3//////
		...
		this.add.image(2310, 535, "blocks");
		///////4//////
		...
		this.add.image(2520, 520, "blocks");
		////////5//////
		...
		this.add.image(2625, 465, "blocks");
		///////6///////
		...
		this.add.image(2520, 400, "blocks");
		//////7//////
		...
		this.add.image(2625, 345, "blocks");
		//////8/////
		...
		this.add.image(2520, 280, "blocks");
		////////9//////
		...
		this.add.image(2415, 475, "blocks");
		//////10//////
		...
		this.add.image(2310, 410, "blocks");
		//////11/////
		...
		this.add.image(2415, 345, "blocks");
		...
		this.add.image(2100, 237, "table").setDepth(6);
		this.add.image(1740, 237, "table").setDepth(6);
		this.add.image(1440, 237, "table").setDepth(6);
		this.add.image(1140, 237, "table").setDepth(6);
		...
		let pipeimage = this.add.image(1700, 310, "pipes2");
		pipeimage.setScale(0.8);
		let pipeimage1 = this.add.image(1700, 368, "pipes2");
		pipeimage1.setScale(0.8);
		let pipeimage2 = this.add.image(1700, 426, "pipes2");
		pipeimage2.setScale(0.8);
		let pipeimage3 = this.add.image(1700, 450, "pipes2");
		pipeimage3.setScale(0.8);
		...
		let pipeimage4 = this.add.image(1500, 310, "pipes2");
		pipeimage4.setScale(0.8);
		let pipeimage5 = this.add.image(1500, 368, "pipes2");
		pipeimage5.setScale(0.8);
		let pipeimage6 = this.add.image(1500, 426, "pipes2");
		pipeimage6.setScale(0.8);
		let pipeimage7 = this.add.image(1500, 450, "pipes2");
		pipeimage7.setScale(0.8);

		let pipe3 = this.add.tileSprite(1700, 574, 60, 54, "tile");
		this.physics.add.existing(pipe3);
		pipe3.body.setImmovable(true);
		pipe3.body.moves = false;
		this.add.image(1700, 575, "pipes");

		let pipe4 = this.add.tileSprite(1500, 574, 60, 54, "tile");
		this.physics.add.existing(pipe4);
		pipe4.body.setImmovable(true);
		pipe4.body.moves = false;
		this.add.image(1500, 575, "pipes");

		let pipe5 = this.add.tileSprite(250, 245, 60, 54, "tile");
		this.physics.add.existing(pipe5);
		pipe5.body.setImmovable(true);
		pipe5.body.moves = false;
		let pipe6 = this.add.tileSprite(900, 245, 60, 54, "tile");
		this.add.image(250, 247, "pipes");

		this.physics.add.existing(pipe6);
		pipe6.body.setImmovable(true);
		pipe6.body.moves = false;
		this.add.image(900, 247, "pipes");
